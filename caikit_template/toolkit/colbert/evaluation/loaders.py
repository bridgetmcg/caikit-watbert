...
from caikit_template.toolkit.colbert.utils.utils import print_message, load_checkpoint, remove_first_and_last_quote
from caikit_template.toolkit.colbert.evaluation.load_model import load_model
