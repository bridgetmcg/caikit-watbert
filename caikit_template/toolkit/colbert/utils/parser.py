...
from caikit_template.toolkit.colbert.utils.runs import Run
from caikit_template.toolkit.colbert.utils.utils import print_message, timestamp, create_directory
...
class Arguments():
    ...
    def add_model_training_parameters(self):
        ...
        self.add_argument('--model_type', dest='model_type', default='bert-base-uncased', choices=['bert-base-uncased', 'bert-large-uncased','xlm-roberta-base', 'xlm-roberta-large', 'roberta-base', 'roberta-large', 'tinybert'], required=False)
