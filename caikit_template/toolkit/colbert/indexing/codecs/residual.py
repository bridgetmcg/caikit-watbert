...
from caikit_template.toolkit.colbert.indexing.codecs.residual_embeddings import ResidualEmbeddings
from caikit_template.toolkit.colbert.utils.utils import print_message, print_torch_extension_error_message
